...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| indoor_1 | 0.00 | 0 | 0 | 0 | 2 | NaN | 11.228 | 1.200 |

## Detailni behy

| Mapa | Repeat | Start x [m] | Start y [m] | Start theta [rad] | Cil x [m] | Cil y [m] | Status | Success | Steps | Goal error [m] | Travelled [m] | Runtime [s] |
|---|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| indoor_1 | 1 | 9.200 | 8.400 | 0.265 (0.084*pi) | 0.800 | 0.800 | timeout | 0 | 20 | 11.477 | 0.144 | 1.509 |
| indoor_1 | 2 | 2.000 | 0.800 | 2.258 (0.719*pi) | 9.200 | 9.200 | timeout | 0 | 20 | 10.978 | 0.379 | 0.891 |
