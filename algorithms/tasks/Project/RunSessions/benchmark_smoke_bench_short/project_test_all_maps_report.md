...
- repeats na mapu: `1`
- timeout: `10` kroku (`1.0 s` pri `Ts = 0.1 s`)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| indoor_1 | 0.00 | 0 | 0 | 0 | 1 | NaN | 11.335 | 3.305 |

## Detailni behy

| Mapa | Repeat | Start x [m] | Start y [m] | Start theta [rad] | Cil x [m] | Cil y [m] | Status | Success | Steps | Goal error [m] | Travelled [m] | Runtime [s] |
|---|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| indoor_1 | 1 | 9.200 | 8.400 | 0.265 (0.084*pi) | 0.800 | 0.800 | timeout | 0 | 10 | 11.335 | 0.005 | 3.305 |
