...
- repeats na mapu: `2`
- timeout: `20` kroku (`2.0 s` pri `Ts = 0.1 s`)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| indoor_1 | 0.00 | 0 | 0 | 0 | 2 | NaN | 11.158 | 1.187 |

## Detailni behy

| Mapa | Repeat | Start x [m] | Start y [m] | Start theta [rad] | Cil x [m] | Cil y [m] | Status | Success | Steps | Goal error [m] | Travelled [m] | Runtime [s] |
|---|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| indoor_1 | 1 | 9.200 | 8.400 | 0.265 (0.084*pi) | 0.800 | 0.800 | timeout | 0 | 20 | 11.353 | 0.026 | 1.347 |
| indoor_1 | 2 | 2.000 | 0.800 | 2.258 (0.719*pi) | 9.200 | 9.200 | timeout | 0 | 20 | 10.964 | 0.343 | 1.027 |
