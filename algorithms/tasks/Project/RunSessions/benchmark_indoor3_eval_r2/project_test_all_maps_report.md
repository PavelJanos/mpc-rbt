...
- benchmark byl ukoncen predcasne na prvnim failu: `timeout`, mapa `indoor_3`, repeat `4`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| indoor_3 | 0.75 | 3 | 0 | 0 | 1 | 1139.0 | 2.053 | 61.189 |

## Detailni behy

| Mapa | Repeat | Start x [m] | Start y [m] | Start theta [rad] | Cil x [m] | Cil y [m] | Status | Success | Steps | Goal error [m] | Travelled [m] | Runtime [s] |
|---|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|
| indoor_3 | 1 | 0.800 | 3.800 | -2.882 (-0.917*pi) | 6.400 | 5.000 | goal | 1 | 1354 | 0.494 | 21.960 | 65.576 |
| indoor_3 | 2 | 9.200 | 3.000 | -2.626 (-0.836*pi) | 3.400 | 9.200 | goal | 1 | 1084 | 0.499 | 24.831 | 45.633 |
| indoor_3 | 3 | 2.400 | 9.200 | 1.642 (pi/2) | 8.800 | 6.400 | goal | 1 | 979 | 0.495 | 17.245 | 40.062 |
| indoor_3 | 4 | 9.200 | 0.800 | 0.337 (0.107*pi) | 3.600 | 6.200 | timeout | 0 | 2050 | 6.722 | 31.377 | 93.486 |
